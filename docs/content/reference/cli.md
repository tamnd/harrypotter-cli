...
```
harrypotter <command> [arguments] [flags]
```

Run `harrypotter <command> --help` for the full flag list on any command. This
...
per operation you declare in `harrypotter/domain.go`.
