...
Most of these come down to network reality or how harrypotter serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

harrypotter rate-limits like any public site. harrypotter already paces
...
Where a surface is gated, harrypotter reads a cookie or token you supply
...
`harrypotter`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what harrypotter actually did
