...
func TestHostWiring(t *testing.T) {
	...
	if want := "harrypotter://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("harrypotter", "about")
	if err != nil || got.String() != "harrypotter://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want harrypotter://page/about", got.String(), err)
	}
}
